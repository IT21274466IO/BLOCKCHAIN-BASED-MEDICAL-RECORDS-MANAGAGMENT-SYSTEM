...
export function Transactiontable({ data, action, functions }) {
  ...
  const thclass =
    'text-xs text-left text-gray-600 uppercase tracking-wide px-4 py-3 bg-gray-100';
  const tdclass =
    'text-sm text-gray-700 px-4 py-4 whitespace-nowrap align-middle';
        ...
        <thead>
          <tr>
            ...
            <th className={thclass}>
              Amount <span className="text-xs font-normal">(LKR)</span>
            </th>
        ...
        <tbody className="divide-y divide-gray-100">
          {data.map((item, index) => (
            ...
            >
              ...
              <td className={tdclass}>
                <span
                  className={`text-xs font-medium px-3 py-1 rounded-full bg-opacity-10 ${
                    item.status === 'Paid'
              ...
              {action && (
                <td className={tdclass}>
                  <MenuSelect datas={DropDown1} item={item}>
                    <div className="bg-gray-100 hover:bg-gray-200 border border-gray-300 text-gray-600 text-xl rounded-lg p-2 cursor-pointer transition">
    ...
    <table className="table-auto w-full">
      <thead className="bg-dry rounded-md overflow-hidden">
        <tr>
          ...
          <th className={thclass}>
            Amout <span className="text-xs font-light">(LKR)</span>
          </th>
    ...
    <table className="table-auto w-full">
      <thead className="bg-dry rounded-md overflow-hidden">
        <tr>
          ...
          <th className={thclass}>
            Price <span className="text-xs font-light">(LKR)</span>
          </th>
          <th className={thclass}>Status</th>
    ...
    <table className="table-auto w-full">
      <thead className="bg-dry rounded-md overflow-hidden">
        <tr>
          ...
          <th className={thclass}>
            Item Price
            <span className="text-xs font-light ml-1">(LKR)</span>
          </th>
