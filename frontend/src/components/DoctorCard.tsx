  ...
  return (
    ...
    >
      <Animated.View
        ...
        className="bg-white rounded-2xl mb-4 p-4 flex-row items-center space-x-4 border border-[#4C8C6B]"
      >
        <Image source={doctor.image} className="w-14 h-14 rounded-full" />
        <View className="flex-1 ml-5">
          <Text className="font-semibold text-[#034C24]">{doctor.name}</Text>
          ...
          <View className="flex-row space-x-4 mt-2 gap-5">
            ...
            <View className="flex-row items-center space-x-1">
              <Feather name="eye" size={14} color="#4C8C6B" />
        ...
        <View className="flex-col items-end space-y-3 gap-3">
          <TouchableOpacity>
            <Ionicons name="heart-outline" size={20} color="#4C8C6B" />
          </TouchableOpacity>
          <TouchableOpacity>
            <Ionicons name="information-circle-outline" size={20} color="#4C8C6B" />
          </TouchableOpacity>
        </View>
      </Animated.View>
    </TouchableOpacity>
